...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('levels')
        .setDescription('Adjusts a users level')
            ...
            try {
                switch (sub) {
                    ...
                    case "remove":
                        ...
                        embed.setDescription(`Removed ${amount} level(s) from ${target}.`).setColor("Green").setTimestamp();
                        break;

                    case "set":
                        await Levels.setLevel(target.id, guildId, amount);
                        embed.setDescription(`Set ${target} level(s) to ${amount}.`).setColor("Green").setTimestamp();
                        break;
